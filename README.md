...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/Praveenjohn50/android_local_manifest/android-14.0/manifest_brcm_rpi.xml --create-dirs
```
...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/Praveenjohn50/android_local_manifest/android-14.0/manifest_brcm_rpi.xml --create-dirs
curl -o .repo/local_manifests/remove_projects.xml -L https://raw.githubusercontent.com/Praveenjohn50/android_local_manifest/android-14.0/remove_projects.xml
```
